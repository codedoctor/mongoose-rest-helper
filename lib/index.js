...
(function() {
  var Hoek, ObjectId, PageResult, _, asObjectId, i18n, isObjectId, mongoose;
  ...
  module.exports = {
    ...
    allLean: function(model, settings, options, cb) {
      var baseQuery, defaultCount, defaultSelect, defaultSort, k, v;
      if (settings == null) {
        settings = {};
      }
      ...
      return model.count(options.where, function(err, totalCount) {
        ...
        query.sort(options.sort || defaultSort);
        return query.lean().exec(function(err, items) {
          if (err) {
            return cb(err);
          }
          return cb(null, new PageResult(items || [], totalCount, options.offset, options.count));
    ...
    count: function(model, settings, options, cb) {
      var baseQuery, k, v;
      if (settings == null) {
        settings = {};
      }
    ...
    getByIdLean: function(model, id, settings, options, cb) {
      var defaultSelect, query;
      if (settings == null) {
        settings = {};
      }
    ...
    Returns a single object base on query
     */
    getOneLean: function(model, settings, options, cb) {
      var baseQuery, defaultSelect, k, query, v;
      if (settings == null) {
        settings = {};
      }
